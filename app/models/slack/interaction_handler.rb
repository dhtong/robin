module Slack
  class InteractionHandler
    ...
    def handle_channel_config
      ...
      channel_config = Records::ChannelConfig.find_or_create_by!(channel_id: channel_id, external_account_id: selected_account_id)
      channel_config.update_attributes(chat_platform: "slack", team_id: team_id, escalation_policy_id: escalation_policy_id)
